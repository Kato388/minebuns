...
var S=class{
  ...
  // keybind ラベル表示用マップ
  static keyLabels={"KeyG":"G","KeyK":"K","KeyF":"F","KeyN":"N","KeyC":"C","KeyI":"I","ShiftRight":"SHIFT"};
  addButton(mod){
...
var q=class extends a{
  constructor(){super("Spider","Movement",{Speed:5});this._comboActive=false;}
  ...
  onRender(){
    let sDown=c.activeKeys.has("KeyS"),mDown=c.activeKeys.has("KeyM");
    if(sDown&&mDown){if(!this._comboActive){this._comboActive=true;this.toggle();}}
    else{this._comboActive=false;}
...
var Kb=class extends a{
  ...
  _buildUI(){
    ...
    const binds=[
      ...
      ["N","NoClip"],["C","Chams"],["S+M","Spider"],["SHIFT","ClickGUI"]
    ];
